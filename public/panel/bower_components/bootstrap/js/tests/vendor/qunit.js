...
(function (global$1) {
  ...
  var equiv = (function () {
  	...
  	function innerEquiv(a, b) {
  		...
  		// Clear the global pair queue and add the top-subject values being compared
  		pairs = [{ a: a, b: b }];
  ...
  Test.prototype = {
  	...
  	// Currently only used for module subject hooks, can be used to add global subject ones
  ...
  // The initial "currentModule" represents the global (or top-subject) module that
  ...
  QUnit.diff = function () {
    ...
    *     then don't run a line-subject diff first to identify the changed areas.
    ...
    *     line-subject diff first to identify the changed areas.
    ...
    */
     ...
     */
  	...
  	/**
    * Do a quick line-subject diff on both strings, then rediff the parts for
    * greater accuracy.
    * This speedup can produce non-minimal diffs.
    * @param {string} text1 Old string to be diffed.
    * @param {string} text2 New string to be diffed.
